...
const PropertyCardsContainer = ({ properties }) => {
  return (
    <div>
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
        ...
        {properties.map((property, idx) => {
          return (
            <div
              key={idx}
              className="border-grey-15 w-full min-w-[300px] snap-start rounded-2xl border p-3.5 transition-transform hover:-translate-y-1"
            >
